...
import org.apache.flink.streaming.connectors.influxdb.sink2.InfluxDBSink;
...
import org.apache.flink.streaming.connectors.influxdb.util.InfluxDBTestSerializer2;
...
@Testcontainers
class InfluxDBSink2IntegrationTestCase extends TestLogger {
    ...
    void testSinkDataToInfluxDB() throws Exception {
        ...
        final InfluxDBSink<Long> influxDBSink =
                InfluxDBSink.builder()
                        .setInfluxDBSchemaSerializer(new InfluxDBTestSerializer2())
